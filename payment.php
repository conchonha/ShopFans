...
<body>
    ...
    <div class="text_care">
        <div class="container">
            <div class="row">
                <h5>1.Payment directly at the company office</h5>
                <p>FANoFAN Company</p>
                <p><b>Address: </b>590 Cach Mang Thang 8, Ward 11, District 3, Ho Chi Minh City</p>
                <p><b>Phone number: </b>0909.090.090 - 0901.010.010 (24/7)</p>
            </div>
        </div>
    </div>
    ...
    <div class="text_care">
        <div class="container">
            <div class="row">
                <h5>2. Cash payment upon product receipt</h5>
                <p>We support payment method COD (Cash on Delivery) - cash payment upon receipt of the product in case you are the orderer and receiver of the product, in order to support maximum ordering and receiving goods.</p>
    ...
    <div class="text_care">
        <div class="container">
            <div class="row">
                <h5>3.Tax cash in another location</h5>
                <p>In case you are not the receiver of the product to pay, you can not transfer or go to the company's office to pay, we support product delivery and collection in 2 different locations.</p>
            </div>
        </div>
    </div>
    ...
    <div class="text_care">
        <div class="container">
            <div class="row">
                <h5>4. Bank transfer payment:</h5>
                <p>You go to any bank to transfer money according to the information below (you do not need a bank account).</p>
                <table style="width: 600px;">
                    <tbody>
                        <tr>
                            ...
                            <td><strong>Joint stock commercial bank for foreign trade</strong> <br>Ho Chi Minh City branch<br><strong>Account holder: </strong>FanoFan Company<br><strong>Account number: </strong> 0511 000 458 855</td>
                        </tr>
                    </tbody>
                </table>
                ...
                <table style="width: 600px;">
                    <tbody>
                        <tr>
                            ...
                            <td><strong>Commercial joint stock company engineering</strong> <br>Ho Chi Minh City branch<br><strong>Account holder: </strong>FanoFan Company<br><strong>Account number: </strong> 191 291 8515 2018</td>
                        </tr>
                    </tbody>
                </table>
