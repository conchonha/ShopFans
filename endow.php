        ...
        <div class="container">
            <div class="row items">
                <div class="col-lg-3 item">
                    ...
                    <span> Guarantee up to 10 years </span>
                </div>
                <div class="col-lg-3 item">
                ...
                <div class="col-lg-3 item">
                    ...
                    <span> Accept all cards</span>
                </div>
                <div class="col-lg-3 item">
                    <img src="images/endow-4.png" alt="">
                    <span> Commitment to 100% satisfaction</span>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 endow_slider">
                    <div class="carousel_testimonial_area">
                        ...
                        <div class="text">
                            <span> Free shipping on orders from to 100$ </span>
                        </div>
                        <hr class="ax">
                        <style>
                            .ax {
                    ...
                    <div class="carousel_testimonial_area" style="margin-top: 200px;">
                        ...
                        <div class="text text1">
                            <span> Register now with us to not
                                miss the best deals </span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="blog_right_sidebar">
                        <div class="add_r_sidebar add_r_sidebar1 ">
                            ...
                            <div class="items">
                                ...
                                <span>The best ceiling fan models for apartments.</span>
                            </div>
                            <div class="items">
                                <img src="images/news2.png" alt="" height="60px">
                                <span>How to properly clean and maintain the ceiling fan ?</span>
                            </div>
                            <div class="items">
                                <img src="images/ceiling5.png" alt="" height="60px">
                                <span>Notes to know before planning to buy a fan.</span>
                            </div>
                            <div class="items">
                                <img src="images/news1.png" alt="" height="60px">
                                <span>Ways to use the energy saving fan you need to know.</span>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="feature_text">
                        <h4>Our distribution partner</h4>
                    </div>
                </div>
            </div>
            <div class="row">
