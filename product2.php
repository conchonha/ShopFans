                        ...
                        <div class="row">
                                ...
                                <div class="my_tabs">
                                    <div class="tab-content tab_content_style">
                                        <div id="tab1" class="tab-pane fade in active">
                                            <div class="blog_tabs">
                                                <a class="fancybox" href="./images/misting.jpg" data-fancybox-group="gallery" title="">
                                                    <img src="./images/misting.jpg" alt="" />
                                                </a>
                                            </div>
                                        </div>
                                        <div id="tab2" class="tab-pane fade">
                                            <div class="blog_tabs">
                                                <a class="fancybox" href="images/misting1.png" data-fancybox-group="gallery" title="">
                                                    <img src="images/misting1.png" alt="" />
                                                </a>
                                            </div>
                                        </div>
                                        <div id="tab3" class="tab-pane fade">
                                            <div class="blog_tabs">
                                                <a class="fancybox" href="./images/misting2.png" data-fancybox-group="gallery" title="">
                                                    <img src="./images/misting2.png" alt="" />
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <ul class="tab_style tab_bottom">
                                            <li class="active">
                                                <div class="blog_single_carousel">
                                                    <a data-toggle="tab" href="#tab1"><img src="./images/misting.jpg" alt="" /></a>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="blog_single_carousel">
                                                    <a data-toggle="tab" href="#tab2"><img src="images/misting1.png" alt="" /></a>
                                                </div>
                                            </li>

                                            <li>
                                                <div class="blog_single_carousel">
                                                    <a data-toggle="tab" href="#tab3"><img src="images/misting2.png" alt="" /></a>
                                                </div>
                                            </li>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="blog_product_details">
                                    <h2 class="blog_heading"><a href="">Kangaroo KG550</a></h2>
                                    ...
                                    <div class="pricing_rate">
                                        ...
                                        <p class="blog_texts">
                                            ...
                                            <ul class="aboutthisitem">
                                                <li>Antibacterial water tank has capacity 2.5L</li>
                                                <li>Has the function of repelling mosquitoes</li>
                                                <li>LED screen displays room temperature</li>
                                                <li>3 wind speeds: normal wind, natural wind and sleep wind</li>
                                                <li>Function to create negative ions to filter the air</li>
                                                <li>Spray function with capacity of 200ml / h</li>
                                                <li>Timer mode (9-15 hours)</li>
                                                <li>Infrared remote control (Remote)</li>
                                                <li>Motor is made from pure copper</li>
                                                <li>Engine protection function when overheating</li>
                                                <li>Warranty 12 months</li>
                                                <li>Convenient to move</li>
                                            </ul>
                                        </p>
                                    </div>
                                ...
                                <div class="product_options_area">
                                    <img src="./images/misting3.png" width="100%" height="354px" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
