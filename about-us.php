...
<body>
    ...
    <div class="container my-our-team mb-5">
        <h2 class="our-team-header" style="color: #17a2b8;">Meet Our Team</h2>
        <div class="row justify-content-center">

            <div class="col-md-4 col-sm-6 col-12 mb-2">
                <div class="our-team">
                    <div class="pic">
                        <img src="images/ava1.jpg" alt="Tien Nguyen">
                    </div>
                    <h3 class="title">Tien Nguyen</h3>
                    <span class="post">Web Deverloper</span>
                    <ul class="social">
                        <li>
                            <a target="_blank" href="http://facebook.com/thanhtung0521" class="fab fa-facebook-f"></a>
                            <a target="_blank" href="http://github.com/thanhtung21051993" class="fab fa-github"></a>
                            <a target="_blank" class="far fa-envelope" href="mailto:LeThanhTung0521@gmail.com?subject=Feedback%20FANoFAN%20FPT-eProject%20(Thanh%20Tung)&cc=TungLTTH1909004@fpt.edu.vn;Hieu.iceTea@gmail.com;DinhHieu8896@gmail.com;HieuNDth1908028@fpt.edu.vn&bcc=HieuNDth1908028@fpt.edu.vn"></a>
                            <a href="skype:live:58a953f7c07a3c92_1?chat" class="fab fa-skype"></a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col-md-4 col-sm-6 col-12 mb-2">
                <div class="our-team">
                    <div class="pic">
                        <img src="images/avatar.jpg" alt="Tien Ngo">
                    </div>
                    <h3 class="title">Tien Ngo</h3>
                    <span class="post">Web Deverloper</span>
                    <ul class="social">
                        <li>
                            <a target="_blank" href="" class="fab fa-facebook-f"></a>
                            <a target="_blank" href="" class="fab fa-github"></a>
                            <a target="_blank" href="#" class="far fa-envelope"></a>
                            <a target="_blank" href="" class="fab fa-skype"></a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col-md-4 col-sm-6 col-12 mb-2">
                <div class="our-team">
                    <div class="pic">
                        <img src="images/ava2.jpg" alt="Hieu nho">
                    </div>
                    <h3 class="title">Hieu Nho</h3>
                    <span class="post">Web Deverloper</span>
                    <ul class="social">
                        <li>
                            <a target="_blank" href="" class="fab fa-facebook-f"></a>
    ...
    <div class="factory-image">
        <p class="factory-p">ABOUT US</p>
        <div class="factory-icon my-link">
            <a> <i class="fab fa-facebook-f mr-4"></i> </a>
            <a> <i class="fab fa-twitter"></i> </a>
            <a> <i class="fab fa-google-plus-g mr-4"></i> </a>
            <a> <i class="fab fa-linkedin-in mr-4"> </i> </a>
            <a> <i class="fab fa-instagram"> </i></a>
        </div>
    </div>
    <div class="row information-data ">
        <div class="col-md-8">
            <h2 class="information-header">THE FANOFAN STORY</h2>
            <hr>
            <p class="information-p ">In 1975, FANoFAN was founded as FANoFAN Limited. We made our first mark with the sale of giant slow-spinning ceiling fans that moved an amazing amount of air. Fans keep large spaces lacking air-conditioning, such as factories and dairy sheds, feel cool and comfortable - and soon,
                a lot of customers also came to us. It all happened quickly afterward (and continues to this day). Just a few years later, we officially changed our name after customers kept calling and asking if we were making "those ceiling fans." When churches wanted to install fans to keep congregations at ease, we developed the first silent fan motor to meet their needs.</p>
            <p class="information-p ">We have created an ENERGY STAR® rated civil blower and won worldwide awards. In 2004, we got the creative idea to make an LED luminaire made of heavy-duty, extruded aluminum so it can handle anything you can pull out, launch a fancy part. is called Fan Light ™.</p>
            <p class="information-p ">And we've supported everything with serious research, in-depth engineering, and an almost obsessive drive for innovation and innovation. No matter what we are doing, we make an effort every day and we do not stop.</p>
        </div>
    </div>
