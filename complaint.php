...
<head>
    ...
    <title>Complaint Inquiries</title>
...
<body>
    ...
    <div class="text_care">
        <div class="container">
            <div class="row">
                <h5> 1. Definitions</h5>
                <p>Complaint handling is the process of receiving and dealing with problems where a service provider fails to comply with a set of rules.Services provided by us (purchasing, inventory, packaging, domestic delivery, goods management ...), provided by the service provider (transport, supply of goods). </p>
            </div>
        </div>
    </div>
    ...
    <div class="text_care">
        <div class="container">
            <div class="row">
                <h5>2. Service complaint handling policy</h5>
                <p>– Time when the Customer makes a complaint: During the use of the service, but not more than 48 hours from the time the Goods is delivered 24 hours. </p>
                <p>– Time to receive and process complaints: Source of Goods 24h commits to receive and handle all complaints that are determined to be valid (specified below).</p>
                <p>– Delivery time of 24 hours for response to receipt / request for additional information: From 1-2 days.</p>
                <p>– For complaints that need to confirm information or work with third parties including (suppliers, carriers ...): We will have to work with these units to obtain information and process complaints complaints.</p>
                <p>– For complaints arising due to our problems, we will handle them within 03 days in the event of no interruption in communication and communication with customers about solutions.</p>
                <p>– For claims arising from an order that does not use Check-in service, we will assist in handling Seller Claims, within 30 days if support for Seller Complaints is unsuccessful or unsuccessful our public will close and deny complaints.</p>
    ...
    <div class="text_care">
        <div class="container">
            <div class="row">
                <h5> 3. Regulations</h5>
                <p>– Time to make a claim: From after purchase, the Customer can make a service complaint.</p>
                <p>– How to make a complaint: Via the function of sending a complaint on the website.</p>
                <p>– Complaint information: Complaint information should contain full content.For missing product claims, the missing product id should be clearly indicated.For claims about wrong, defective, or damaged goods, content of claim request and photos of product / goods statuschemical need complaints.
                    For other complaints,we may request additional information to be able to work with the supplier or shipping unit (if needed).
                </p>
                <p>– Contact form: We will be exchanged by phone and directly on the complaint details page.</p>
                <p>– Complaint assistance is not within the scope of our service commitments: For the Claims related to the supplier when the supplier violates the terms of transaction of goods (transaction terms on sale websites row); or appeal the complaints
                    not using the service of checking goods; we will directly handle or assist customers to process. We will ask Customer to cooperate in handling Supplier Complaints.
                </p>
                <p>– We will handle complaints related to product cracking; do not receive and handle claims related to performance, part details, warranty and product quality.
                </p>
                <p>– In some cases, we will ask the Customer to proactively make a complaint with the supplier (for example: The customer has had a prior agreement with the supplier about the product, we only make payment as required bridge; The client did not post sign to use Checking service, ...).</p>
    ...
    <div class="text_care">
        <div class="container">
            <div class="row">
                <h5> 4. Compensation policy</h5>
                <p>– In case we do not comply with the commitment to purchase service: compensate 100% of the value of goods & purchase fees for missing products; Compensation agreement with wrongly purchased products.</p>
                <p>– In case the goods are damaged during transportation: 100% refund of value of damage and packing fee if an error arises due to our failure to comply with Customer's reasonable packing requirements; refund 100% of the value of the damage and refund 100% of the value of the damage and negotiate for compensation / share in cases of unreasonable and uncontrollable failures during transport.</p>
