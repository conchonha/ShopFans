            ...
            <div class="row d-flex align-items-center">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 mb-3">
                    ...
                    <div class="account_card_area">
                        <ul id="account_nav">
                            <li><a href="my-account.html">Account <i class="fas fa-long-arrow-alt-right"></i></a>
                            </li>
                            <li>
                                <a href="cart.html">
                                ...
                                <div class="cart_down_area">
                                    ...
                                    <div class="cart_shoptings">
                                        <a href="checkout.html" class="cart_shoptings-link">Buy now</a>
                                    </div>
                                </div>
                            </li>
                        </ul>
                ...
                <div class="col-md-12">
                    ...
                    <div class="main_menu">
                        <ul id="nav_menu" class="active_cl">
                            ...
                            <li>
                                <a href="shop.html"> <span class="Clothings">Product</span> <i class="fas fa-caret-down"></i></a>
                                <div class="mega_menu_list">
                                    <div class="single_megamenu">
                                        <div class="items_list">
                                            <a href="product.html"><i class="fa fa-angle-right"></i> Ceiling Fans</a>
                                            <a href="product1.html"><i class="fa fa-angle-right"></i> Tower Fans</a>
                                            <a href="product2.html"><i class="fa fa-angle-right"></i> Misting Fans</a>
                                            <a href="product3.html"><i class="fa fa-angle-right"></i> Steam Fans</a>
                                            <a href="product4.html"><i class="fa fa-angle-right"></i> Stand Fans</a>
                                            <a href="product5.html"><i class="fa fa-angle-right"></i> Wall Fans</a>
                                            <a href="product6.html"><i class="fa fa-angle-right"></i> Box Fans</a>
                                            <a href="product7.html"><i class="fa fa-angle-right"></i> Exhaust Fan</a>
                                        </div>
                                    </div>
                                </div>
                            </li>
                            <li>
                                <a href="guarantee.html"><span class="Lookbook">Guarantee</span></a>
                            </li>
                            <li>
                                <a href="endow.html"><span class="Footwear">Endow</span></a>
                            </li>
                            <li>
                                <a href="about-us.html"><span class="Footwear">About</span></a>
                            </li>
                            <li>
                                <a href="contact.html"><span class="Footwear">Contact</span></a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="my_tabs">
                                    <div class="tab-content tab_content_style">
                                        <div id="tab1" class="tab-pane fade in active">
                                            <div class="blog_tabs">
                                                <a class="fancybox" href="./images/stand.jpg" data-fancybox-group="gallery" title="">
                                        ...
                                        <div id="tab2" class="tab-pane fade">
                                            <div class="blog_tabs">
                                                <a class="fancybox" href="images/stand1.png" data-fancybox-group="gallery" title="">
                                                    <img src="images/stand1.png" alt="" />
                                                </a>
                                            </div>
                                        </div>
                                        <div id="tab3" class="tab-pane fade">
                                            <div class="blog_tabs">
                                                <a class="fancybox" href="images/stand2.png" data-fancybox-group="gallery" title="">
                                                    <img src="images/stand2.png" alt="" />
                                                </a>
                                            </div>
                                        </div>
                                        <div id="tab4" class="tab-pane fade">
                                            <div class="blog_tabs">
                                                <a class="fancybox" href="images/stand3.jpg" data-fancybox-group="gallery" title="">
                                                    <img src="images/stand3.jpg" alt="" />
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <ul class="tab_style tab_bottom">
                                            <li class="active">
                                                <div class="blog_single_carousel">
                                                    <a data-toggle="tab" href="#tab1"><img src="./images/stand.jpg" alt="" /></a>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="blog_single_carousel">
                                                    <a data-toggle="tab" href="#tab2"><img src="images/stand1.png" alt="" /></a>
                                                </div>
                                            </li>

                                            <li>
                                                <div class="blog_single_carousel">
                                                    <a data-toggle="tab" href="#tab3"><img src="images/stand2.png" alt="" /></a>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="my_deal">
                                    <a href="cart.html"><button> BUY NOW <br><span class="btn_buy">Deliver to home</span></button></a>
                                    <img src="./images/deals.png" width="100%" alt="">
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="blog_product_details">
                                    <h2 class="blog_heading"><a href="">NANOCO FS40-19PRD</a></h2>
                                    ...
                                    <div class="pricing_rate">
                                        ...
                                        <p class="blog_texts">
                                            ...
                                            <ul class="aboutthisitem">
                                                <li>ULTRA QUIET & ENERGY EFFICIENCY: Equipped with DC silent motor, the Pelonis pedestal fan is engineered for quiet operation (as low as 38 dB) which is less than half as loud as most standard fans. It is perfect
                                                    for your bedroom or nursing room. The DC motor also offers greater energy efficiency and save up to 35% of the energy cost than its AC counterpart.</li>
                                                <li>POWERFUL WIND & WIDE OSCILLATION ANGLE: 12 speed settings and 12-hour timer design allow you to customize your breeze needs in your house, living room and office. With 5 high-quality blades and a strong
                                                    motor, this Pelonis oscillation fan could provide strong wind to boost the cooling effect when using with air conditioner. The 85° oscillation angle and 24° tilt angle will extend wind the coverage to
                                                    every corner of the room.</li>
                                                <li>EASY TO USE: Featuring blue LED display, remote control and auto power off functions, the floor fan is designed for long-range and full function control (up to 6 meters). With the height adjustable between
                                                    3.5 and 4 feet, it could get you fully covered no matter you are sitting on the couch or lying in bed</li>
                                ...
                                <div class="product_options_area">
                                    <img src="images/stand4.jpg" height="229px" width="100%" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                                                    ...
                                                    <table class="table table-bordered  table-striped">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>15.75 x 15.75 x 51.18 inches</td>
                ...
                <div class="footer_menu_area">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                        <div class="help_support help_border">
                            <h2>customer care</h2>
                            <ul class="footer_menu">
                                <li><a href="infomation.html">Information security policy</a></li>
                                <li><a href="commit.html">Commitment to satisfaction</a></li>
                                <li><a href="complaint.html">Complaint inquiries</a></li>
                                <li><a href="payment.html">Payment Guide</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
