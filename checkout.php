                ...
                <div class="col-md-12">
                    ...
                    <div class="main_menu">
                        <ul id="nav_menu" class="active_cl">
                            ...
                            <li>
                                <a href="shop.php"> <span class="Clothings">Product</span> <i class="fas fa-caret-down"></i></i></a>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <div class="Continue_button continue_top place_order">
                                                <h2> <a href="shop.php"> Forgot an Item? </a> <a href="quen-mat-khau.php">Forgot your password?</a></h2>
